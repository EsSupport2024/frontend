  ...
  return (
    <section className="bg-lightOrange" id="certification">
      <div className="container mx-auto px-4 py-16 lg:px-24 lg:py-32">
        ...
        <div className="lg:w-2/4 w-3/4 text-justify mt-2 m-auto lg:mx-0">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 mt-10 w-3/4 lg:w-full m-auto">
          ...
          <div className="rounded-xl bg-darkGray justify-end p-5 flex flex-col gap-5 lg:col-span-2 lg:py-10">
            <div className="font-bold text-xs lg:text-xl text-white">
